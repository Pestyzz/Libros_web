document.addEventListener('DOMContentLoaded', function () {
    let multipleCardCarousel1 = document.querySelector("#carouselNovedades");
    ...
    if (window.matchMedia("(min-width: 768px)").matches) {
        ...
        document.querySelector("#carouselNovedades .carousel-control-next").addEventListener("click", function () {
        ...
        document.querySelector("#carouselNovedades .carousel-control-prev").addEventListener("click", function () {
