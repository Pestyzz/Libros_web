"""
Django settings for libros_web project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'home_app.context_processor.cart_detail',
                'home_app.context_processor.favorite_detail',
                'home_app.context_processor.categories',
            ],
        },
    },
]

WSGI_APPLICATION = 'libros_web.wsgi.application'
